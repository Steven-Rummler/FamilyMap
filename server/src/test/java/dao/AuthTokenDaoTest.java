...
public class AuthTokenDaoTest {
    ...
    public void setUp() throws DataAccessException
    {
        ...
        bestAuthToken = new AuthToken("user", "token");
    ...
    public void findFail() throws DataAccessException {
        ...
        assertEquals(null, aDao.find("invalidID"));
    }

    @Test
    public void authenticatePass() throws DataAccessException {
        aDao.insert(bestAuthToken);
        assertEquals(bestAuthToken.getToken(), aDao.authenticate(bestAuthToken.getUser()));
    }

    @Test
    public void authenticateFail() throws DataAccessException {
        assertEquals(null, aDao.authenticate(bestAuthToken.getUser()));
    }
}
